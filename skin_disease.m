function varargout = skin_disease(varargin)
% SKIN_DISEASE MATLAB code for skin_disease.fig
%      SKIN_DISEASE, by itself, creates a new SKIN_DISEASE or raises the existing
%      singleton*.
%
%      H = SKIN_DISEASE returns the handle to a new SKIN_DISEASE or the handle to
%      the existing singleton*.
%
%      SKIN_DISEASE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SKIN_DISEASE.M with the given input arguments.
%
%      SKIN_DISEASE('Property','Value',...) creates a new SKIN_DISEASE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before skin_disease_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to skin_disease_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help skin_disease

% Last Modified by GUIDE v2.5 10-Mar-2023 16:52:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @skin_disease_OpeningFcn, ...
                   'gui_OutputFcn',  @skin_disease_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before skin_disease is made visible.
function skin_disease_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to skin_disease (see VARARGIN)

% Choose default command line output for skin_disease
...
% UIWAIT makes skin_disease wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = skin_disease_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global a;global skw;global Skin;global im;
